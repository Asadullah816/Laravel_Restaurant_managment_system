                    ...
                    <form id="contact" action="{{ route('reservation') }}" method="POST">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <fieldset>
                                    <input name="name" type="text" name="name" id="name"
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <fieldset>
                                    <input name="email" type="text" id="email" name="email"
                                        pattern="[^ @]*@[^ @]*" placeholder="Your Email Address" required="">
                                </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <fieldset>
                                    <input name="phone" name="phone" type="text" id="phone"
                                        placeholder="Phone Number*" required="">
                                </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <fieldset>
                                    <select value="number-guests" name="guest" name="number-guests"
                                        id="number-guests">
